...
const int pingPin = 40; // Trigger Pin of Ultrasonic Sensor
const int echoPin = 41; // Echo Pin of Ultrasonic Sensor
...
void pump_start()
{
 digitalWrite(pump, LOW);  // turn the LED on (HIGH is the voltage level)
  delay(1000);
}

void pump_stop()
{
  digitalWrite(pump, HIGH);   // turn the LED off by making the voltage LOW
  delay(1000);
}
